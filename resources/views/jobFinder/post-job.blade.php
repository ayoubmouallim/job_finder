    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8 mb-5">
                ...
                @endif
                <form action=" {{ route('save-job') }} " method="POST" class="p-5 bg-white">
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0 ">
                            ...
                            <div class="alert alert-danger"> {{ Session::get('category') }}</div>
                            @endif
                    ...
                    <div class="row form-group mb-5">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="company" class="form-control" placeholder="eg. Facebook, Inc.">
                        </div>
                        @error('company')
                        <small class="form-text text-danger"> {{ $message }}</small>
                        @enderror
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0 ">
                            ...
                            <br>
                            @if (Session::has('type'))
                            <div class="alert alert-danger"> {{ Session::get('type') }}</div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0 ">
                            ...
                            <div class="alert alert-danger"> {{ Session::get('location') }}</div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label class="font-weight-bold" for="fullname">Job price</label>
