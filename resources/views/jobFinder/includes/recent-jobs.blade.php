        ...
        <div class="row">
            ...
            <div class="col-lg-3 sidebar">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="border">
                        <a href="#" class="company-wrap"><img src="{{asset('assest/images/company-1.jpg')}}"
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="border">
                        <a href="#" class="company-wrap"><img src="{{asset('assest/images/company-2.jpg')}}"
                                class="img-fluid" alt="Colorlib Free Template"></a>
                        <div class="text p-3">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="border">
                        <a href="#" class="company-wrap"><img src="{{asset('assest/images/company-3.jpg')}}"
                                class="img-fluid" alt="Colorlib Free Template"></a>
                        <div class="text p-3">
